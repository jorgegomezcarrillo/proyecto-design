              ...
              : function (e, t, n) {
                  ...
                  if (c) {
                    ...
                    if (((u = [m ? c.firstChild : c.lastChild]), m && d)) {
                      (p =
                        (s =
                          (r = (i = (o = (a = c)[A] || (a[A] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === N &&
                          r[1]) && r[2]),
                        (a = s && c.childNodes[s]);
                      ...
                      (d &&
                        (p = s =
                          (r = (i = (o = (a = e)[A] || (a[A] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === N &&
                          r[1]),
                      !1 === p)
                    )
                      while ((a = (++s && a && a[l]) || (p = s = 0) || u.pop()))
      ...
      serializeArray: function () {
        return this.map(function () {
          ...
          .filter(function () {
            var e = this.type;
            return (
              this.name && !E(this).is(':disabled') && pt.test(this.nodeName) && !dt.test(e) && (this.checked || !fe.test(e))
            );
          })
          .map(function (e, t) {
            var n = E(this).val();
